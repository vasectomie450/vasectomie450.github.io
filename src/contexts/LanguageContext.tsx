...
const translations = {
  fr: {
    ...
    'rendezvous.questionnaire.important.title': 'Important',
    'rendezvous.questionnaire.important.desc': 'Ce questionnaire doit idéalement être complété avant la prise de rendez-vous pour permettre une consultation et vasectomie en une seule visite.',
    'rendezvous.questionnaire.required': 'Questionnaire santé requis',
    ...
    'rendezvous.virtual.flexible': 'Flexible et pratique',
    ...
    'rendezvous.onsite.note.title': 'Note importante',
    'rendezvous.onsite.note.desc': 'Dans ce cas, la vasectomie pourrait ne pas avoir lieu le jour même.',
    'rendezvous.info.title': 'Informations importantes',
    'rendezvous.info.available': 'Rendez-vous disponibles sous 14 jours',
    'rendezvous.info.no.referral': 'Aucune référence médicale requise',
    'rendezvous.info.same.day': 'Consultation et procédure le même jour possible',
    'rendezvous.info.parking': 'Stationnement gratuit disponible',
    'rendezvous.info.both.clinics': 'Services disponibles dans les deux cliniques',
    'rendezvous.info.emergency': 'Ligne d\'urgence 24h/24 post-opératoire',
    ...
    'rendezvous.cta.questionnaire': 'Questionnaire santé',
    'rendezvous.cta.booking': 'Réserver en ligne',
  },
  en: {
    // Navigation
    'nav.home': 'Home',
    ...
    'rendezvous.questionnaire.important.title': 'Important',
    'rendezvous.questionnaire.important.desc': 'This questionnaire should ideally be completed before booking to allow consultation and vasectomy in a single visit.',
    'rendezvous.questionnaire.required': 'Health questionnaire required',
    ...
    'rendezvous.virtual.flexible': 'Flexible and convenient',
    ...
    'rendezvous.onsite.note.title': 'Important note',
    'rendezvous.onsite.note.desc': 'In this case, the vasectomy might not take place on the same day.',
    'rendezvous.info.title': 'Important information',
    'rendezvous.info.available': 'Appointments available within 14 days',
    'rendezvous.info.no.referral': 'No medical referral required',
    'rendezvous.info.same.day': 'Consultation and procedure same day possible',
    'rendezvous.info.parking': 'Free parking available',
    'rendezvous.info.both.clinics': 'Services available at both clinics',
    'rendezvous.info.emergency': '24/7 post-operative emergency line',
    ...
    'rendezvous.cta.questionnaire': 'Health questionnaire',
    'rendezvous.cta.booking': 'Book online',
  }
};
