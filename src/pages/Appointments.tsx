      ...
      <section className="section-padding bg-gradient-to-br from-ivory-50 to-teal-50">
        <div className="container-max text-center">
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            <span className="text-gradient">{t('appointments.title')}</span>
          </h1>
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              {t('appointments.steps.title')}
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              {t('appointments.steps.subtitle')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="card relative">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">
                {t('appointments.questionnaire.title')}
              </h3>
              <p className="text-gray-600 mb-4 text-center">
                {t('appointments.questionnaire.desc')}
              </p>
              <button 
              ...
              >
                ...
                <span>{t('appointments.questionnaire.cta')}</span>
              </button>
              ...
              <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-sm text-amber-800">
                    <p className="font-medium mb-1">{t('appointments.questionnaire.important.title')}:</p>
                    <p>{t('appointments.questionnaire.important.desc')}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card relative">
              ...
              >
                ...
                <span>{t('appointments.booking.cta')}</span>
              </button>
            </div>
          </div>
          ...
          <div className="card bg-gradient-to-r from-teal-50 to-primary-50 border-teal-200 mb-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
              {t('appointments.options.title')}
            </h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <h4 className="text-lg font-semibold text-gray-900 mb-3">
                  {t('appointments.same.day.title')}
                </h4>
                <p className="text-gray-600 mb-4">
                  {t('appointments.same.day.desc')}
                </p>
                <div className="flex items-center space-x-2 text-teal-600">
                  <CheckCircle className="w-4 h-4" />
                  <span className="text-sm font-medium">{t('appointments.questionnaire.required')}</span>
                </div>
              </div>
              
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <h4 className="text-lg font-semibold text-gray-900 mb-3">
                  {t('appointments.virtual.title')}
                </h4>
                <p className="text-gray-600 mb-4">
                  {t('appointments.virtual.desc')}
                </p>
                <div className="flex items-center space-x-2 text-primary-600">
                  <CheckCircle className="w-4 h-4" />
                  <span className="text-sm font-medium">{t('appointments.virtual.flexible')}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card bg-amber-50 border-amber-200">
            <h3 className="text-xl font-semibold text-amber-900 mb-3">
              {t('appointments.onsite.title')}
            </h3>
            <p className="text-amber-800 mb-3">
              {t('appointments.onsite.desc')}
            </p>
            <div className="flex items-start space-x-2">
              <div className="w-2 h-2 bg-amber-600 rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-amber-800 text-sm">
                <strong>{t('appointments.onsite.note.title')}:</strong> {t('appointments.onsite.note.desc')}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-max">
          <div className="card max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
              {t('appointments.info.title')}
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start space-x-2">
                  <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 flex-shrink-0"></span>
                  <span>{t('appointments.info.available')}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 flex-shrink-0"></span>
                  <span>{t('appointments.info.no.referral')}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 flex-shrink-0"></span>
                  <span>{t('appointments.info.same.day')}</span>
                </li>
              </ul>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start space-x-2">
                  <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 flex-shrink-0"></span>
                  <span>{t('appointments.info.parking')}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 flex-shrink-0"></span>
                  <span>{t('appointments.info.both.clinics')}</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 flex-shrink-0"></span>
                  <span>{t('appointments.info.emergency')}</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="section-padding bg-gradient-to-r from-teal-600 to-primary-600 text-white">
        <div className="container-max text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            {t('appointments.cta.title')}
          </h2>
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            {t('appointments.cta.description')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              ...
              <span>{t('appointments.cta.questionnaire')}</span>
            </button>
            <button 
              onClick={handleBookingClick}
            ...
            >
              ...
              <span>{t('appointments.cta.booking')}</span>
            </button>
          </div>
        </div>
      </section>
